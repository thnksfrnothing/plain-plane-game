...
to_start = font.render('Press Enter', True, 'aquamarine4')
...
font = pygame.font.SysFont('8bit', 100)
score: abs = 0
paused = False
health = 3 
...
while run:
	...
	score_text = font.render(f'{score}', True, 'darkturquoise')
	...
	if move == False:
		screen.fill('light green')
		screen.blit(to_start, (WIDTH / 2 - 170, HEIGHT / 2 - 200))
	else:
		pass
